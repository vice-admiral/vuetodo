		...
		<div class="col-sm-4 col-md-6">
			<div class="card-body">
				<div class="header">
					...
					<button class="btn btn-custom btn-sm" @click="addNewTask">Add New Task</button>
				</div>
				<app-modal v-if="isModalOpen" @addTask="isModalOpen = !isModalOpen"></app-modal>

				<ul class="list-group">
					<li class="list-group-item card-text" v-for="(task, index) in tasks" style="cursor: pointer">
